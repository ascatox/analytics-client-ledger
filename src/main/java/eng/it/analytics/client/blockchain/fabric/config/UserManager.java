package eng.it.analytics.client.blockchain.fabric.config;

import eng.it.analytics.client.blockchain.fabric.helper.ChannelInitializationManager;
import eng.it.analytics.client.exception.SmartClientException;
import org.apache.commons.io.IOUtils;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import org.hyperledger.fabric.sdk.exception.InvalidArgumentException;
import eng.it.analytics.client.blockchain.fabric.utils.Utils;
...
public class UserManager {
    ...
    public static UserManager getInstance(Configuration configuration, Organization organization) throws SmartClientException, InvalidArgumentException {
    ...
    public void completeUsers() throws SmartClientException {
        try {
