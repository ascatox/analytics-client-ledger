...
import eng.it.analytics.client.blockchain.fabric.config.OrdererConfig;
import eng.it.analytics.client.blockchain.fabric.config.Organization;
import eng.it.analytics.client.blockchain.fabric.config.PeerConfig;
...
public class ChannelInitializationManager {
    ...
    public static ChannelInitializationManager getInstance(HFClient client, ConfigManager configManager, Organization organization) throws SmartClientException, InvalidArgumentException {
    ...
    private ChannelInitializationManager(HFClient client, ConfigManager configManager, Organization organization) throws SmartClientException, InvalidArgumentException {
        initializeChannel(client, configManager, organization);
    }

    private void setupEnv(HFClient client, ConfigManager configManager, Organization organization) throws InvalidArgumentException, SmartClientException {
        this.client = client;
    ...
    private void initializeChannel(HFClient client, ConfigManager configManager, Organization organization) throws SmartClientException, InvalidArgumentException {
        ////////////////////////////
