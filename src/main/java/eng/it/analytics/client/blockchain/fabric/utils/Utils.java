...
package eng.it.analytics.client.blockchain.fabric.utils;
...
public class Utils {
    ...
    public static void getMessageViolations(Set<ConstraintViolation<?>> violations) throws SmartClientException {
        ...
        if (StringUtils.isNotEmpty(messageBuilder.toString()))
            throw new SmartClientException(messageBuilder.toString());
    }

    public static void getMessageViolationsResult(Set<ConstraintViolation<?>> violations) throws SmartClientException {
        if (violations.isEmpty())
            return ;
        StringBuilder messageBuilder = new StringBuilder();
        for (ConstraintViolation violation : violations) {
